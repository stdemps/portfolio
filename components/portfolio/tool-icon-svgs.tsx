  ...
  return (
    ...
    >
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(330deg) scaleY(0.97) rotate(-330deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(300deg) scaleY(1.06) rotate(-300deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(270deg) scaleY(1.075) rotate(-270deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(240deg) scaleY(1.015) rotate(-240deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(210deg) scaleY(0.997) rotate(-210deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(180deg) scaleY(1.045) rotate(-180deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(150deg) scaleY(0.982632) rotate(-150deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(120deg) scaleY(1.064299) rotate(-120deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(90deg) scaleY(1.265966) rotate(-90deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(60deg) scaleY(1.082368) rotate(-60deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(30deg) scaleY(1.120701) rotate(-30deg)" }}
      />
      <path
        ...
        fill="currentColor"
        style={{ transformOrigin: "50px 50px", transform: "rotate(0deg) scaleY(1.009034) rotate(0deg)" }}
      />
    </svg>
  )
}
